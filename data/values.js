// Master list of values + their definitions
...
// Lane definitions and order, left → right.
// This is also what we export/import against.
export const LANES = [
  {
    id: "core",
    title: "Core / Non-negotiable",
    desc: "If I betray this, I'm not myself.",
    color: "var(--accent-core)"
  },
  {
    id: "important",
    title: "Important",
    desc: "I actively want more of this.",
    color: "var(--accent-imp)"
  },
  {
    id: "nice",
    title: "Nice to have",
    desc: "Good, but not central.",
    color: "var(--accent-nice)"
  },
  {
    id: "not",
    title: "Not important",
    desc: "I'm okay not prioritizing this.",
    color: "var(--accent-low)"
  },
  {
    id: "unsorted",
    title: "Unsorted",
    desc: "Start here. Classify outward.",
    color: "var(--text-dim)"
  }
];

export const LANE_ORDER = LANES.map(l => l.id);